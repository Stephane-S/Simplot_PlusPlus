...
class Groups:
    ...
    def add_group(self, group_name):
        ...
        self.groups_id[group_name] = group_name.replace(" ", "_")
    ...
    def change_group_name(self, old, new):
        if old != new:
            ...
            del self.groups_id[old]
            self.groups_id[new] = new.replace(" ", "_")
    ...
    def update_group(self, group, seq):  #seq is a list here
        ...
        # print ("self.ungrouped_seq:", self.ungrouped_seq)
